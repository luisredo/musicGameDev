...
function addSpaceToText(word,idFrame){
    switch (word) {
        case "\\n":
          ...
          break;
        case ".":
            document.getElementById(idFrame).innerHTML += `<span>`+ word.split[i].text + `</span>` ;
          break;
        case ",":
            document.getElementById(idFrame).innerHTML += `<span>`+ word.split[i].text + `</span>` ;
          break;
...
function addSpaceToTextWTag(word,idFrame,tag,index,solution){
    if (tag==""){
        ...
        if(solution){
            document.getElementById(idFrame).innerHTML += `<span><input type="text" id="p`+ index +`" value="word.split[i].text" \>`+ word.split[i].text + ` </span>` ;
        } else {
            document.getElementById(idFrame).innerHTML += `<span><input type="text" id="p`+ index +`" value="" \>`+ word.split[i].text + ` </span>` ;
        }
    }
